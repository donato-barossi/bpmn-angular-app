...
import { BPMNWorkflowComponent } from './bpmnworkflow.component';
...
describe('BPMNWorkflowComponent', () => {
  let component: BPMNWorkflowComponent;
  let fixture: ComponentFixture<BPMNWorkflowComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ BPMNWorkflowComponent ]
    });

    fixture = TestBed.createComponent(BPMNWorkflowComponent);
